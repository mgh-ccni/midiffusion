...
from runners.diffusion import Diffusion, DiffusionSDEDIT
...
def parse_args_and_config():
    ...
    parser.add_argument("--mean", type=float, default=0.04)
    parser.add_argument("--var", type=float, default=0.002)
    ...
    parser.add_argument(
        "--gpu_id", type=int, default=0, help="number of steps involved"
    )
    parser.add_argument(
        "--eta",
        type=float,
    ...
    if not args.test and not args.sample and args.use_pretrained:
...
def main():
    ...
    try:
        if args.use_sdedit:
            print('Training with baseline SDEdit...')
